 ...
 include_once "includes/header.php"; 
    ...
    if (isset($_POST['register'])) {  
        if(empty($_POST['agree'])) {
            $note= "<font color='red'>Please Confirm The Application</font>"; }
   ...
   $sql = "INSERT INTO expert(id,fname, mname,lname,nationality, contactperson, pinno, businessregno, datereg, address, email, tele,faxno,spec,qualif,experience,purpose, oldregno,dateof,position,role, compname, appldate,username,password
    ...
    // mysqli_query($conn, "INSERT into notification(userid) SELECT userid FROM user order by userid DESC LIMIT 1");
        ...
        $note= "<font color='red'>User not Added, Registration Incomplete, Please Enter the Valid Credentials</font>";
                ...
                <div class="col-lg-14">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <font color="teal" size="3%">Please Fill the Valid Information</font>
                        </div>
                        <div class="form-group">
                         <?php echo "<label>&nbsp &nbsp".$note."</label"; ?>
                         </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                         <div class="form-group">
                                            <label> Name</label>
                                            <input class="form-control" name="fname" placeholder="First Name" required="required"> <br>
                                            <input class="form-control" name="mname" placeholder="Middle Name" required="required"> <br>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <label>Fax No</label>
                                            <input type="Number" min="0" class="form-control" name="faxno" placeholder="Fax Number">
                                        </div>
                                        <div class="form-group">
                                            <label>Business Registration No.(Where applicable)</label>
                                            <input class="form-control" name="businessregno" placeholder="Reg No:"><br>
                                            <input class="form-control" id="date" name="datereg" placeholder="Date Registered">
...
experts:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="oldregno" placeholder="Reg No:"><br> 
                                            <input class="form-control" id="date2" name="dateof" placeholder="Previous Date of Registration ">
                                        </div>
