...
$result = mysqli_query($conn, "SELECT * FROM expert WHERE id=$uid");
            ...
            <div class="col-lg-6">
                    <div class="chat-panel panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-comments fa-fw"></i> <?php echo $fname." ".$mname." ".$lname;?>
                        ...
                        <div class="panel-body">
                            <ul class="chat">
                                        ...
                                        <?php
                                         $messageu = "SELECT * FROM u".$sender." WHERE (msgfrom='".$uid."' OR msgto='".$id."') ORDER BY id ASC";
                                             $resultu = $conn->query($messageu);
                          ...
                          echo "<li class=\"left clearfix\">
                                    <div class=\"chat-body clearfix\">
                                        ...
                                        else { echo "<li class=\"right clearfix\">
                                    <div class=\"chat-body clearfix\">
                                        <div class=\"header\">
                ...
                <div class="col-lg-5">
                    <div class="panel panel-default">
                        ...
                        <!--  <p>First Name:&nbsp;&nbsp;<font color="orange"><?php echo $fname; ?></font></p>
                         ...
                         <p>User ID:&nbsp;&nbsp;<font color="orange"><?php echo $id; ?></font></p>
